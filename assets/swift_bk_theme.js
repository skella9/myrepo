(function ($) {
  ...
  theme.initAjaxAddToCartForm = function ($form_param) {
    $form_param.on('submit', function (evt) {
      ...
      if($form.find('[name="pillowcase_option"]:checked').val() !== undefined && $form.find('[name="pillowcase_option"]:checked').val() !== 'none' ){
        $.ajax({
          type: 'POST',
          url: theme.routes.cart_add_url,
          data: { id: $form.find('[name="pillowcase_option"]:checked').val(),quantity:$form.find('[name="quantity"]').val() },
          async:false
        });
      }
      ...
      $.post(theme.routes.cart_add_url + '.js', formData, function (itemData) {
